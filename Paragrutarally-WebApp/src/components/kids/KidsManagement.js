// src/components/kids/KidsManagement.js
...
function KidsManagement() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // Fetch kids data
                const kidsQuery = query(collection(db, 'kids'), orderBy('lastName'));
    ...
    const confirmDelete = (kid) => {
        setDeleteConfirmation(kid);
    };
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            setKids(kids.filter(kid => kid.id !== deleteConfirmation.id));
                            ...
                            {loading ? (
                              ...
                              <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <h3 className="mt-2 text-sm font-medium text-gray-900">No kids found</h3>
                                    <p className="mt-1 text-sm text-gray-500">
                                        Get started by adding a new kid or updating search criteria.
                                    </p>
                                    <div className="mt-6">
                                        <Link
                                            to="/kids/new"
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Are you sure you want to delete {deleteConfirmation.firstName}{' '}
                                                {deleteConfirmation.lastName}? This action cannot be undone.
                                            </p>
                                        </div>
                                    </div>
                                </div>

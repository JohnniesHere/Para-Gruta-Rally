// src/components/layout/ConfirmDialog.js
...
function ConfirmDialog({
                           ...
                           confirmText = 'Confirm',
                           cancelText = 'Cancel',
                           confirmButtonType = 'danger', // 'danger', 'warning', 'success', 'primary'
                           onConfirm,
                           onCancel,
                           icon = 'warning' // 'warning', 'error', 'info', 'question', 'success'
                       }) {
    if (!isOpen) return null;

    // Map button types to classes
    const buttonClasses = {
    ...
    const buttonClass = buttonClasses[confirmButtonType] || buttonClasses.primary;

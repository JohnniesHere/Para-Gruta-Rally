...
// Validation
        ...
        'teams.swap': 'Swap Vehicle',
        'teams.swapVehicles': 'Swap Vehicles',
        'teams.swappingFor': 'Swapping for {vehicleName}',
        'teams.swapVehicleSuccess': 'Vehicle swapped successfully!',
        'teams.swapVehicleError': 'Error swapping vehicle: {error}',
        'teams.swapVehicleConfirm': 'Are you sure you want to swap the vehicle for {vehicleName}? This action cannot be undone.',
        'teams.swapVehicleCancel': 'Swap cancelled',
        'teams.swapVehicleConfirmTitle': 'Confirm Vehicle Swap',
        'teams.currentVehicle': 'Current Vehicle',
        'teams.swapNow': 'Swap Now',
        'teams.swapVehicle': 'Swap Vehicle',
        'teams.swapWith': 'Swap with {vehicleName}',
        'teams.swapVehicleWithKid': 'Swap Vehicle with Kid',
        'teams.assignVehicleFirst': 'Assign a vehicle to this team first to enable swapping.',
        'teams.current': 'Current Vehicle',
        'teams.assigned': 'Assigned Vehicle',
    ...
    he: {
        'teams.current': 'רכב נוכחי',
        'teams.assigned': 'רכב מוקצה',
        'teams.swapVehicleWithKid': 'החלף רכב עם ילד',
        'teams.assignVehicleFirst': 'הקצה רכב לצוות זה תחילה כדי לאפשר החלפה.',
        'teams.swapNow': 'החלף עכשיו',
        'teams.swapVehicle': 'החלפת רכב',
        'teams.swapWith': 'החלף עם {vehicleName}',
        'teams.currentVehicle': 'רכב נוכחי',
        'teams.swapVehicleConfirm': 'האם אתה בטוח שברצונך להחליף את הרכב ל-{vehicleName}? פעולה זו אינה ניתנת לביטול.',
        'teams.swapVehicleCancel': 'החלפה בוטלה',
        'teams.swapVehicleConfirmTitle': 'אשר החלפת רכב',
        'teams.swappingFor': 'מחליף ל-{vehicleName}',
        'teams.swapVehicleSuccess': 'הרכב הוחלף בהצלחה!',
        'teams.swapFor': 'מחליף ל-{vehicleName}',
        'teams.swapVehicles': 'החלפת רכבים',
        'teams.swap': 'החלפת רכב',

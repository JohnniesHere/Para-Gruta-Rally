...
// Validation messages
        ...
        'teams.viewingCurrentInfo': 'אתם צופחם במידע הנוכחי של צוות {teamName}. בצעו שינויים למטה כדי לעדכן! 🏎️',
        'teams.backToTeams': 'חזור לצוותים',
        'teams.teamIdentity': 'זהות הצוות 🏎️',
        'teams.racingInstructors': 'מדריכי מירוצים 👨‍🏫',
        'teams.teamRacers': 'ילדי הצוות ({max}/{current}) 🏎️',
       ...
       // Kids Management Page (Hebrew)
        ...
        'analytics.tooltip.teamAnalysis.description': 'הצוות הזו מלא ב-{utilizationRate}% עם {currentMembers} מתוך {maxCapacity} ילדים אפשריים.',
